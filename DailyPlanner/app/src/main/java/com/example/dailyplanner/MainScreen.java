...
public class MainScreen extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if (v.getId()== R.id.btn_createAppointment){
        ...
        else if(v.getId()==R.id.btn_deleteAppointment) {
                deleteAppointmentPopup(v);

            }
        else if (v.getId()==R.id.btn_viewEditAppointment){
        ...
        else if (v.getId()==R.id.btn_moveAppointment){
                Intent intent = new Intent(getBaseContext() , EditAppointmentScreen.class);
                intent.putExtra("Date" , date ); // format - dd/MM/yyyy
